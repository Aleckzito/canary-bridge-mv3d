...
-- MV3D local bridge
-- NOTE: mv3dEditorBridgeEnabled opens only the local bridge process port.
-- NOTE: mv3dBridgePlayerOperationMode gates player-bound opcodes such as attack, item use and NPC dialog.
-- NOTE: mv3dBridgeMapEditMode gates map edit, map save, metadata/text updates and map snapshot streaming.
