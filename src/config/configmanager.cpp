...
bool ConfigManager::load() {
	...
	if (!loaded) {
		...
		loadBoolConfig(L, MV3D_EDITOR_BRIDGE_ENABLED, "mv3dEditorBridgeEnabled", true);
		loadBoolConfig(L, MV3D_EDITOR_BRIDGE_MAP_EDIT_MODE, "mv3dBridgeMapEditMode", false);
		loadBoolConfig(L, MV3D_EDITOR_BRIDGE_PLAYER_OPERATION_MODE, "mv3dBridgePlayerOperationMode", false);
